package com.riceclient.launcher.utils;

import java.io.File;

public enum OSHelper {
    WINDOWS("AppData" + File.separator + "Roaming" + File.separator + ".cringeclient"),
    MAC("Library" + File.separator + "Applacation Support" + File.separator + "cringeclient"),
    LINUX(".cringeclient");
